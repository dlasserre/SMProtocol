...
//1376: added method  getLeadActivity
//Source: http://ahmeddirie.com/technology/web-development/marketos-updated-soap-php-client-and-the-new-way-to-submit-leads/
...
class MarketoAPI
{
     ...
     */
    public function getLeadActivity($leadEmail, $lastId=0)
    {
        $sinceTimestamp='2014-01-01 00:00:01';
        $sinceTimestamp=(date('Y')-1).'-'.date('m').'-01 00:00:01';
        $actRec = null;
        $actRecList = null;
        ...
        $actTypes = array();
        $actTypes[] = 'AddToList';
        $actTypes[] = 'VisitWebpage';
        $actTypes[] = 'FillOutForm';
        $actTypes[] = 'RegisterForEvent';
        /*
        $actTypes[] = 'OpenEmail';
        $actTypes[] = 'NewLead';
        $actTypes[] = 'PushLeadToSales';
        $actTypes[] = 'ConvertLead';
        $actTypes[] = 'PushLeadUpdatesToSales';
        $actTypes[] = 'DeleteLeadFromSales';
        $actTypes[] = 'ReceiveSalesEmail';
         */
     ...
     * @param int    $lastId          ID of last activity
     */
    public function getStudioInstalDate($leadEmail, $lastId=0)
    {
        $sinceTimestamp='2014-01-01 00:00:01';
        $sinceTimestamp=(date('Y')-1).'-'.date('m').'-01 00:00:01';
        $actRec = null;
            ...
            try {
                ...
                if (isset($success->leadActivityList)) {
                    ...
                    if ($result->returnCount > 0) {
                        ...
                        foreach ($actRecList as $actRec) {
                            //var_dump( $actRec);
                            if ($actRec->id > $lastId && $actRec->mktgAssetName == 'www.talend.com/designer_post_install') {
                                return 'Studio Installed on '.$actRec->activityDateTime;
                                break 2;
                            }
                        }
        ...
        return $actRec->activityDateTime;
    }
